...
function DoacoesCard({id, name, cpf,cestabasica, cestaverde, quantcestabasica,quantacestaverde,datacestabasica,datacestaverde,localcestabasica,localcestaverde}){
